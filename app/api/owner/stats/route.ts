...
async function saveBill(period: string, label: string, bookings: number, minutes: number, dueDate: string) {
  ...
  const ref  = adminDb.collection('notarygarcia_bills').doc(period);
...
export async function GET(request: NextRequest) {
  ...
  const [
    ...
    countBetween('notarygarcia_bookings',      cur.start,  cur.end),
    countBetween('notarygarcia_bookings',      prev.start, prev.end),
    countBetween('notarygarcia_consultations', cur.start,  cur.end),
    countBetween('notarygarcia_consultations', prev.start, prev.end),
