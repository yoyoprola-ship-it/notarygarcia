...
export default function BookingModal({
  ...
  return (
    ...
    >
      <div
        className="bg-ink-light border border-gold/25 w-full sm:max-w-md max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-lg shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="sticky top-0 bg-ink-light border-b border-gold/20 px-6 py-4 flex items-center justify-between">
          <div>
...
const inputCls =
  'w-full px-4 py-3 bg-ink border border-gold/25 rounded text-cream placeholder:text-cream/30 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold transition';

const btnCls =
  'w-full px-4 py-3 bg-gold hover:bg-gold-light active:bg-gold text-ink-deep font-bold uppercase tracking-wide rounded transition-colors disabled:opacity-50';
