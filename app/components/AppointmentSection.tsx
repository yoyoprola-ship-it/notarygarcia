...
export default function AppointmentSection({ lang }: Props) {
  ...
  return (
    <section
      id="book"
      className="px-6 py-16 bg-ink border-y border-gold/15"
    >
      <div className="max-w-2xl mx-auto">
        ...
        {days && !loading && (
          <div className="bg-ink-light border border-gold/20 rounded-xl overflow-hidden">
            {/* Month header */}
                ...
                {calendarCells.map((cell, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`aspect-square rounded-lg border flex flex-col items-center justify-center transition-all ${cellCls} ${isToday ? 'ring-2 ring-gold ring-offset-1 ring-offset-ink-light' : ''}`}
                    >
